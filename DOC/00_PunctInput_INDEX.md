...
**對應版本**：v1.1（2026-07-11，呼叫快捷鍵依 DD-8 改為 Ctrl + Alt + /）
...
| 版本 | v1.1（manifest assembly version 1.1.0.0），2026-07-11 |
...
| 操作 | 觸發方式 | 行為 | 對應需求編號 |
|------|---------|------|--------------|
| Ctrl + Alt + / | 全域熱鍵（MOD_CONTROL + MOD_ALT + VK_OEM_2 + MOD_NOREPEAT；v1.1 依 DD-8 改鍵） | 視窗顯示／隱藏切換 | FR-001 |
...
| 文件 | 用途 | 版本 |
|------|------|------|
| `00_PunctInput_INDEX.md` | 本檔，專案索引 | v1.1（2026-07-11） |
| `01_PunctInput_PRD.md` | 產品需求文件（含設計決策紀錄 DD-1 至 DD-8、風險 R1 至 R5） | v1.1（2026-07-11） |
| `02_PunctInput_SPEC_v1.0.md` | 專案規格書（實作基準；檔名依慣例維持 v1.0，內容就地更新） | v1.1（2026-07-11） |
| `03_PunctInput_SRS_v1.0.md` | 軟體需求規格書（FR-001 至 FR-013、NFR-01 至 NFR-05；檔名依慣例維持 v1.0，內容就地更新） | v1.1（2026-07-11） |
| `04_PunctInput_MODIFY_LOG.md` | 異動摘要紀錄（最新版在上） | v1.1（2026-07-11） |
