...
|------|------|--------|-----------|---------|
| FR-001 | 全域快捷鍵 Ctrl + Alt + /（MOD_CONTROL + MOD_ALT + VK_OEM_2 + MOD_NOREPEAT）切換視窗顯示／隱藏（v1.1 依 DD-8 改鍵，原 Ctrl + /） | P0 | §6.1、§6.3 | 對應 V8（keybd_event 注入 Ctrl + Alt + /：切換隱藏與重現皆 PASS，2026-07-11）；v1.0 原鍵位驗證紀錄見 V5 |
...
| FR-012 | Ctrl + Alt + / 註冊失敗顯示警告訊息，仍可由系統匣操作 | P2 | §9 | 模擬 Ctrl + Alt + / 已被其他程式佔用之情境下啟動本工具，驗證顯示「全域快捷鍵 Ctrl + Alt + / 註冊失敗（被其他程式佔用）。仍可由系統匣圖示操作。」警告視窗，且系統匣圖示與選單操作仍正常 |
...
*本文件依事實清單 FR-001 至 FR-013、NFR-01 至 NFR-05 逐條轉譯；FR／NFR 編號固定，後續增修不得改號。追蹤矩陣第三章之 PRD 目標引自 `01_PunctInput_PRD.md` 第三章。沿革：v1.0（2026-07-11）首版落檔；v1.1（2026-07-11）FR-001／FR-009／FR-011／FR-012 之呼叫快捷鍵依 DD-8 改為 Ctrl + Alt + /。*
