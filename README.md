...
本分支（Aphy）為 45 符號擴充變體，建置產出為 `dist\PunctInput_Aphy.exe`；7 符號基礎版請見 master 分支。

## 功能特色

1. **一鍵成對輸入**：「」『』《》【】〔〕﹝﹞六組括號各為一鍵，點一下直接輸入成對符號。
...
## 符號清單（Aphy 符號集，5 列共 45 鍵；列配置 11／11／2／11／10）
